...
class URATAHrpsysConfigurator(HrpsysConfigurator):
    ...
    def defJointGroups (self):
        ...
        elif self.ROBOT_NAME == "KXRL2W2L5A3H2": #future731 added this
            rarm_group = ['rarm', ['RARM_JOINT0', 'RARM_JOINT1', 'RARM_JOINT2', 'RARM_JOINT3']]
            larm_group = ['larm', ['LARM_JOINT0', 'LARM_JOINT1', 'LARM_JOINT2', 'LARM_JOINT3']]
            rleg_group = ['rleg', ['RLEG_JOINT0', 'RLEG_JOINT1', 'RLEG_JOINT2', 'RLEG_JOINT3', 'RLEG_JOINT4']]
            lleg_group = ['lleg', ['LLEG_JOINT0', 'LLEG_JOINT1', 'LLEG_JOINT2', 'LLEG_JOINT3', 'LLEG_JOINT4']]
            head_group = ['head', ['HEAD_JOINT0', 'HEAD_JOINT1']]
            self.Groups = [rarm_group, larm_group, rleg_group, lleg_group, head_group]
        else:
    ...
    def setStAbcParameters (self):
        if self.ROBOT_NAME == "STARO":
            ...
            self.setStAbcParametersKXRL2W2L5A3H2()
...
#        abcp.move_base_gain=0.8
    ...
    def setStAbcParametersKXRL2W2L5A3H2 (self): #future731 added this
        abcp=self.abc_svc.getAutoBalancerParam()[1]
        abcp.default_zmp_offsets=[[0.01, -0.005, 0.0], [0.01, 0.005, 0.0], [0, 0, 0], [0, 0, 0]];
#        abcp.move_base_gain=0.8
        self.abc_svc.setAutoBalancerParam(abcp)
    ...
    def setResetPose(self):
        if self.ROBOT_NAME == "STARO":
            ...
            self.seq_svc.setJointAngles(self.kxrl2w2l5a3h2ResetPose(), 5.0)
